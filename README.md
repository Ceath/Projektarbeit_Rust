...
Zum Erstellen der Projektarbeit wurde "IntelliJ IDEA" und "Visual Code" verwendet, der Code wurde mit der Rust Version 1.45.0 entwickelt. Da Rust sich noch in Entwicklung befindet, ist es möglich, das Teile des Quellcodes nicht mit neueren Versionen kompatible sind oder die Dokumentation veraltet ist.  
